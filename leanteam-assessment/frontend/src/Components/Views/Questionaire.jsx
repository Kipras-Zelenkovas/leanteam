...
import { icons } from "../../misc/iconsAvailable";
...
export const Questionaire = () => {
    ...
    const [criteriaIcon, setCriteriaIcon] = useState(undefined);
                        ...
                        {(values, errors) => (
                            <Form className="flex flex-wrap w-full h-full p-4">
                                ...
                                <div className="flex flex-col w-full p-2">
                                    ...
                                    <div
                                        name="icon"
                                        className="flex flex-wrap border-2 border-gray-400 rounded-md w-full p-2 focus:border-text"
                                    >
                                        {icons.map((icon) => {
                                            return (
                                                <div
                                                    ...
                                                    key={icon.value}
                                                    className={`flex flex-wrap w-8 h-8 rounded-md justify-center content-center cursor-pointer group transition-all duration-500 ease-in-out ${
                                                        criteriaIcon ===
                                                        icon.value
                                                            ? "bg-primary"
                                                            : "bg-red-400"
